 ...
 *                              NFT Contract
 * Author: BCEZ
 * SutdentID: 63070501067, 63070501043, 63070501067
 * ContractName: cockroach
 *
 **********************************************************************************
 */
...
contract cockroach is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Cockroach: not owner");
        _;
    }
     ...
     */
    constructor() ERC721A("Cockroach NFT", "EKI") {
        owner = msg.sender;
    }
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "Cockroach: not exist");
